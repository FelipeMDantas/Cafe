...
const testimonials = [
  {
    message: `The coffee here is absolutely amazing! The baristas are skilled and the atmosphere is perfect for both 
    work and relaxation.`,
    name: "Alice Johnson",
    profession: "Graphic Designer",
  },
  {
    message: `I love coming to this cafe. The pastries are always fresh, and the staff is incredibly friendly. It's 
    my go-to spot for meetings.`,
    name: "Michael Lee",
    profession: "Freelance Writer",
  },
  {
    message: `A hidden gem! The ambiance is cozy, and the menu offers a great variety. The chai latte is a 
    must-try!`,
    name: "Samantha Green",
