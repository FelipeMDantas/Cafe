        ...
        <div className="w-full flex flex-col lg:flex-row gap-12 xl:gap-20">
          ...
          >
            <div className="relative flex items-start">
              <div className="xl:mxa-w-[420px] xl:text-right xl:flex xl:flex-col xl:items-end">
          ...
          <div
            className="flex-1 flex flex-col justify-around text-center xl:text-left gap-12 xl:gap-0
          max-w-[400px] mx-auto xl:max-w-none xl:mx-0"
          >
            <div className="relative flex items-start">
              <div className="xl:mxa-w-[420px] xl:text-left xl:flex xl:flex-col xl:items-start">
                <div className="mb-6 flex justify-center items-center">
                  <Image
