...
const Hero = () => {
  return (
    <section className="h-[80vh] xl:h-screen relative text-white">
      ...
      <div
        className="container mx-auto h-full flex flex-col xl:flex-row items-center z-30 
      relative"
      >
        <div className="flex flex-1 flex-col text-center justify-center items-center xl:pb-12 gap-10 h-full">
